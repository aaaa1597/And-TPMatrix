...
void Java_com_test_tpdrw_NativeFunc_create(JNIEnv *pEnv, jclass type, jint id) {
    gpSufacesLists[id] = new CppSurfaceView(id);
}

void Java_com_test_tpdrw_NativeFunc_surfaceCreated(JNIEnv *pEnv, jclass type, jint id, jobject surface) {
    gpSufacesLists[id]->createThread(pEnv, surface);
}

void Java_com_test_tpdrw_NativeFunc_surfaceChanged(JNIEnv *pEnv, jclass type, jint id, jint width, jint height) {
...
void Java_com_test_tpdrw_NativeFunc_surfaceDestroyed(JNIEnv *pEnv, jclass type, jint id) {
